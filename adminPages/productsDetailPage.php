<?php
  ...
  if(isset($_GET['editDetail'])){
    ...
    header('Location:../superAdminPages\productsDetailEditPage.php');
  }
    ...
    <nav class="navbar navbar-expand-lg" id="navbar">
        ...
        <div class="collapse navbar-collapse ml-5" id="navbarNav">
          ...
          <form class="form-inline" id="account">
            ...
            <a class="btn" href="../adminsDetails.php" type="button" id="user"><i class="fa-solid fa-user fa-2xl"></i></a>
        ...
        <div class="container">
          <div class="row" >
            ...
            <div class="col-lg-6" id="productDetails">
              ...
              <div id="buttons">
                <a href="productsDetailPage.php?editDetail=<?php echo $pid ?>" class="btn ml-5" type="submit" id="cartbutton" name="buy">Edit Details</a>
                <a href="productsDetailPage.php?deleteProduct= <?php echo $pid ?>" class="btn ml-5" type="submit" id="cartbutton" name="buy">Delete Product</a>
              </div>
            </div>
          </div>
        </div>
